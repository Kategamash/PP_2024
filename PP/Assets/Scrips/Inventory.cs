...
public class Inventory : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        for(int i = 0; i < maxCount; i++) // рандомное заполнение для теста
        {
    ...
    public void SelectObject()
    {
        ...
        else
        {
            ...
            {
                if(II.count + currentItem.count <= 10)
                {
                    II.count += currentItem.count;
                }
                else
                {
                    AddItem(currentID, data.items[II.id], II.count + currentItem.count - 10);
                    II.count = 10;
                }
